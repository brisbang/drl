...
-- Demonic
    ...
    --TODO: From this point, isPossible checks are missing.
	--To do level-based assessments we need to have better awareness of level generation and signal when levels are concluded
